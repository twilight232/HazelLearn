/*
    ...
    OpenGL loader generated by glad 0.1.36 on Sun Feb 25 14:29:45 2024.
...
extern "C" {
    ...
    typedef void* (*GLADloadproc)(const char* name);  //GLADloadproc是一个传入一个const char*，返回void*的函数指针
